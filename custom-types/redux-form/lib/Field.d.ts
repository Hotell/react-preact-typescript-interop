...
interface BaseFieldProps<P = {}> extends Partial<CommonFieldProps>, Partial<CustomFieldProps> {
  name: string
...
export interface WrappedFieldProps extends Partial<CustomFieldProps> {
